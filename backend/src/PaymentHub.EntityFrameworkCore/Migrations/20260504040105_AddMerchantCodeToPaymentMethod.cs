...
{
    /// <inheritdoc />
    public partial class AddMerchantCodeToPaymentMethod : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentMethods_TenantId_MerchantCode_MethodId",
                table: "PaymentMethods",
                columns: new[] { "TenantId", "MerchantCode", "MethodId" },
                unique: true);
        }
